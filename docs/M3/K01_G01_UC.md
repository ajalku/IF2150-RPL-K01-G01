...
| *UC03* | *Melihat Detail Laporan* | *Pengguna dapat melihat detail informasi dari laporan berupa lokasi, nama masalah, kategori, label tingkat kedaruratan laporan, serta foto dan deskripsi apabila tersedia.* | *Pengguna, Admin* | *KF05, KF06* |
...
**Skenario Alternatif 1: Pengguna/Admin Belum Mengaktifkan Pengaturan Akses Lokasi di Perangkat, Lalu Mengizinkan Sistem untuk Mengakses Lokasi di Perangkat**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna/Admin menekan salah satu laporan pada halaman utama yang dapat difilter berdasarkan terbaru, urgensi, dan popularitas* | *Sistem menampilkan sebagian detail laporan* |
| 2 | *Pengguna/Admin menggulir halaman* | *Sistem menampilkan seluruh detail laporan* |
| 3 | *Pengguna/Admin menekan peta, namun belum mengaktifkan location di perangkatnya* | *Sistem gagal berpindah ke halaman peta yang berisi laporan di sekitar pengguna, lalu menampilkan pop up yang meminta Pengguna/Admin untuk mengizinkan sistem mengakses lokasi di perangkat * |
| 4 | *Pengguna/Admin menyetujui izin sistem untuk mengakses lokasi* | *Sistem berpindah ke halaman peta yang berisi laporan di sekitar pengguna* |
| 5 | *Pengguna/Admin menekan titik penanda lokasi pada peta* | *Sistem menampilkan pop-up sebagian detail laporan* |
| 6 | *Pengguna/Admin memilih "lihat detail laporan"* | *Sistem berpindah halaman ke halaman laporan yang berisi detail laporan* |


**Skenario Alternatif 2: Pengguna/Admin Belum Mengaktifkan Pengaturan Akses Lokasi di Perangkat dan Tetap Tidak Mengizinkan Sistem untuk Mengakses Lokasi di Perangkat**
...
| 2 | *Pengguna/Admin menggulir halaman* | *Sistem menampilkan seluruh detail laporan* |
| 3 | *Pengguna/Admin menekan peta, namun belum mengaktifkan location di perangkatnya* | *Sistem gagal berpindah ke halaman peta yang berisi laporan di sekitar pengguna, lalu menampilkan pop up yang meminta Pengguna/Admin untuk mengizinkan sistem mengakses lokasi di perangkat * |
| 4 | *Pengguna/Admin tidak menyetujui izin sistem untuk mengakses lokasi* | *Sistem gagal berpindah ke halaman peta yang berisi laporan di sekitar pengguna* |
| 5 | | *Sistem berpindah kembali ke halaman sebelumnya yang terakhir diakses oleh Pengguna/Admin* |



**Skenario Alternatif 3: API Peta Gagal Dimuat**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna/Admin menekan salah satu laporan pada halaman utama yang dapat difilter berdasarkan terbaru, urgensi, dan popularitas* | *Sistem menampilkan sebagian detail laporan* |
| 2 | *Pengguna/Admin menggulir halaman* | *Sistem menampilkan seluruh detail laporan* |
| 3 | *Pengguna/Admin menekan peta* | *Sistem meminta data peta melalui API* |
| 4 | | *API gagal memberikan respons sehingga sistem gagal memuat peta dan menampilkan pesan error bahwa peta tidak dapat dimuat* |
| 5 | *Pengguna/Admin merefresh laman sistem* | *Sistem kembali meminta data peta melalui API* |
| 6 | | *Sistem menampilkan halaman peta yang berisi laporan di sekitar pengguna apabila API berhasil memberikan respons* |
| 7 | *Pengguna/Admin menekan titik penanda lokasi pada peta* | *Sistem menampilkan pop-up sebagian detail laporan* |
| 8 | *Pengguna/Admin memilih "lihat detail laporan"* | *Sistem berpindah halaman ke halaman laporan yang berisi detail laporan* |
