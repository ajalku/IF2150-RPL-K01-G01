...
| Revisi | Deskripsi |
| :--- | :--- |
| UC10 | Menambahkan UC10 (mengedit profile) |
...
| *UC10* | *Mengedit Profil* | *Pengguna dapat mengupdate profil dan akunnya* | *Pengguna* | *KF02* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna menekan edit profil*|*Sistem menampilkan pilihan profile yang bisa diedit*|
| 2 | *Pengguna mengedit nama, nomor telepon, password* | - |
| 3 | *Pengguna menekan tombol "simpan"* | *Sistem memperbarui database pengguna*|

<br>

**Skenario Alternatif 1: Pengguna mengganti password lebih dari 3 kali dalam waktu dekat**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna mengedit password 3 kali dan menyimpan* | *Sistem menyimpan ke database.*|
| 2 | *Pengguna mengedit password ke-4 dan mencoba menyimpan* | *Sistem menampilkan peringatan password tidak dapat diubah dan membutuhkan waktu H+7 hari setelah perubahan password terakhir* |
---
---
